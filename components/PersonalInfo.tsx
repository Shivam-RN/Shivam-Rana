  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold"> My <span className="text-purple text-4xl font-bold">Education</span></h2>
        ...
        {education.map((edu, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Timeline Dot */}
              <div className="absolute left-1/2 top-0 transform -translate-x-1/2 bg-gray-400 border-4 border-[#8245ec] w-12 h-12 sm:w-16 sm:h-16 rounded-full z-10 flex justify-center items-center">
                <Image
                  src={edu.img}
                  alt={edu.school}
                  width={64}
